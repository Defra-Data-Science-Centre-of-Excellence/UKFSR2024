...
vegetable_supply <- aws.s3::s3read_using(FUN = read_csv,
                              ...
                              object = "theme_2/input_data/t2_1_4/2_1_4f_vegetable_supply.csv")
...
save_graphic(vegetable_supply_chart, "2.1.4f", "vegetable supply")
save_csv(vegetable_supply2, "2.1.4f", "vegetable supply")
