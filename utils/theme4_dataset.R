...
cover <- c("UK Food Security Report 2024",
           "Theme 4",
           "Description",
           "This dataset contains the underlying data for the indicators in Theme 4",
           "Last update",
           "11 December 2024",
           "Next update",
           "December 2027",
...
csvs <- bucket_manifest(file_ext = "csv") |> 
  dplyr::filter(stringr::str_starts(folder, "theme_4") & stringr::str_ends(folder, "output/csv")) |> 
