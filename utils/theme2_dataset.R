...
cover <- c("UK Food Security Report 2024",
           "Theme 2",
           "Description",
           "This dataset contains the underlying data for the indicators in Theme 2:",
...
csvs <- bucket_manifest(file_ext = "csv") |> 
  dplyr::filter(stringr::str_starts(folder, "theme_2") & stringr::str_ends(folder, "output/csv")) |> 
