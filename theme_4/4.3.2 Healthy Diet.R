...
FSR_4_1_9 <- FSR_4_1_9 %>%
  pivot_longer(cols = c(`2020-21`, `2021-22`, `2023-24`), 
               names_to = "Year", 
               values_to = "Value")
...
save_graphic(FSR_4_1_9_plot, '4.3.2d','Percentage of disposable income') + 
  save_csv(FSR_4_1_9, '4.3.2d','Percentage of disposable income')