...
save_graphic(samples_cht, "3.1.3g", "samples reported by las e w ni")
save_csv(samples, "3.1.3g", "samples reported by las e w ni")
...
save_graphic(samples_scot_cht, "3.1.3h", "samples reported by las scot")
save_csv(samples_scot, "3.1.3h", "samples reported by las scot")