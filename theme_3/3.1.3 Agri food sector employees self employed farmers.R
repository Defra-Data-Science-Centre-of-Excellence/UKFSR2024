...
save_graphic(FSR_3_1_3a_plot, '3.1.3a', ' Agri food sector employees self employed farmers') + 
  save_csv(FSR_3_1_3a, '3.1.3a', ' Agri food sector employees self employed farmers')