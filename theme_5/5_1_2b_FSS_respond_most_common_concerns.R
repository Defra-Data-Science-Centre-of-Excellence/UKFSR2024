...
t5_1_2b <- aws.s3::s3read_using(FUN = read_csv,
                                ...
                                object = "theme_5/t_5_1_2/output/csv/5_1_2b_FSS_respond_ten_most_common_prompted_concerns.csv",
                                col_types = colspec)

t5_1_2b$`Types of concern` <- factor(t5_1_2b$`Types of concern`, levels = c("Food prices","Food poverty and food inequality","Ultra-processed, or over-processing of food",
...
t5_1_2b_plot <- ggplot(t5_1_2b, aes(x= reorder(`Types of concern`, `Percentage of respondents`), y=`Percentage of respondents`)) +
...
save_graphic(t5_1_2b_plot, "5.1.2b", "fss respond ten most common prompted concerns")

save_csv(t5_1_2b, "5.1.2b", "fss respond ten most common prompted concerns")
