...
t5_1_7h <- aws.s3::s3read_using(FUN = read_csv,
                                bucket = ukfsr::s3_bucket(),
                                object = "theme_5/t5_1_7/output/csv/5_1_7h_perc_meat_establish_rated_good_hyg_Scot_2022-23.csv")

t5_1_7h$year <- factor(t5_1_7h$year, levels = c("2022","2023"))
...
t5_1_7h_plot <- ggplot(t5_1_7h, aes(x= year, y= perc)) +
...
save_graphic(t5_1_7h_plot, "5.1.7h", "perc meat establish rated good hyg Scot 2022-23")
