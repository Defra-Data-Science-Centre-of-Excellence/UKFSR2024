...
t5_3_1f <- aws.s3::s3read_using(FUN = read_csv,
                                ...
                                object = "theme_5/t_5_3_1/output/csv/5_3_1f_number_FHRS_Scot.csv")

t5_3_1f$quarter <- factor(t5_3_1f$quarter, levels = c("Q1 2019/20","Q2 2019/20","Q3 2019/20","Q4 2019/20","Q1 2020/21","Q2 2020/21",
...
t5_3_1f$quarter_wrap = str_wrap(t5_3_1f$quarter, width = 4)

t5_3_1f$quarter_wrap <- as.factor(t5_3_1f$quarter_wrap)
...
t5_3_1f_plot <- ggplot(t5_3_1f, aes(x=factor(quarter_wrap), y= FHR, group =1)) +
  theme_classic() +
