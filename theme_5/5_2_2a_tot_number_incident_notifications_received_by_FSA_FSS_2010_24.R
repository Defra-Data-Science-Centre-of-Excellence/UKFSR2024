...
t5_2_2a <- aws.s3::s3read_using(FUN = read_csv,
                                bucket = ukfsr::s3_bucket(),
                                object = "theme_5/t_5_2_2/output/csv/5_2_2a_tot_number_incident_notifications_received_by_FSA_FSS_2010_24.csv",
                                col_types = colspec)
...
save_graphic(t5_2_2a_plot, "5.2.2a", "tot number incident notifications received by FSA FSS 2010 24")

save_csv(t5_2_2a, "5.2.2a", "tot number incident notifications received by FSA FSS 2010 24")
