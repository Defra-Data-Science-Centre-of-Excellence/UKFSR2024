...
t5_3_1c <- aws.s3::s3read_using(FUN = read_csv,
                                ...
                                object = "theme_5/t5_1_1/output/csv/5_3_1c_no_food_bus_iss_food_hyg_rating_quarter_eng_wales_ni.csv")
...
t5_3_1c$quarter_wrap = str_wrap(t5_3_1c$quarter, width = 4)

t5_3_1c$quarter_wrap <- as.factor(t5_3_1c$quarter_wrap)
...
t5_3_1c_plot <- ggplot(t5_3_1c, aes(x=factor(quarter_wrap), y= FHR, group =1)) +
  theme_classic() +
  theme_ukfsr(base_family = "GDS Transport Website", base_size = 14) +
  geom_line(linewidth=1, colour = af_colours_1) +
  labs(y = "Number of FHRS assessments conducted") +
...
save_graphic(t5_3_1c_plot, "5.3.1c", "no food bus iss food hyg rating quarter eng wales ni")

save_csv(t5_3_1c, "5.3.1c", "no food bus iss food hyg rating quarter eng wales ni")
