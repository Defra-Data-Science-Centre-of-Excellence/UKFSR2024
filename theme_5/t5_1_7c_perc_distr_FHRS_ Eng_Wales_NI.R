...
t5_1_1c <- aws.s3::s3read_using(FUN = read_csv,
                                ...
                                object = "theme_5/t5_1_7/output/csv/5_1_7c_perc_distr_FHRS_ Eng_Wales_NI.csv")

t5_1_7c$quarter <- factor(t5_1_7c$quarter, levels = c("Q1 2019/20","Q2 2019/20","Q3 2019/20","Q4 2019/20","Q1 2020/21","Q2 2020/21",
...
t5_1_7c_long$rating <- factor(t5_1_7c_long$rating, levels = c("5 - Very good","4 - Good","3 - Generally satisfactory",
                                                              "2 - Improvement necessary","1 - Major improvement necessary",
                                                              "0 - Urgent improvement necessary"))

af_categorical_colours <- afcolours::af_colours("categorical", n = 6)
names(af_categorical_colours)=levels(t5_1_7c_long$rating)

t5_1_7c_long$rating <- factor(t5_1_7c_long$rating, levels = rev(levels(t5_1_7c_long$rating)))

t5_1_7c_long$quarter_wrap = str_wrap(t5_1_7c_long$quarter, width = 4)

t5_1_7c_long$quarter_wrap <- as.factor(t5_1_7c_long$quarter_wrap)
...
level_order <- c("Q1\n2019/20","Q2\n2019/20","Q3\n2019/20","Q4\n2019/20","Q1\n2020/21","Q2\n2020/21",
  ...
  t5_1_7c_plot <- ggplot(t5_1_7c_long,aes(x=quarter_wrap, y=perc, group=rating)) +
...
save_graphic(t5_1_7c_plot, "5.1.7c", "perc distr FHRS Eng Wales NI")
