...
t_5_1_5b <- aws.s3::s3read_using(FUN = read_csv,
                                 ...
                                 object = "theme_5/t5_1_5/output/csv/5_1_5b_tot_number_human_cases_perc_hosp.csv")

t5_1_5b_labels$`Causative agent` <- factor(t5_1_5b_labels$`Causative agent`, levels = c("Salmonella spp.","Enteric viruses[1]","Campylobacter spp.",
...
t5_1_5b_long_labels <- t5_1_5b_labels %>% 
  pivot_longer(-`Causative agent`, 
               names_to = c("Year", ".value"), 
               names_sep="_" )

t5_1_5b_long_labels$Year <- factor(t5_1_5b_long_labels$Year, levels = c("2019","2020","2021","2022","2023","Total"))
...
t5_1_5b_long_labels$`Causative agent_wrap` = str_wrap(t5_1_5b_long_labels$`Causative agent`, width = 14)

t5_1_5b_labels$`Causative agent_wrap` <- factor(t5_1_5b_labels$`Causative agent_wrap`, levels = c("Salmonella spp.","Enteric viruses[1]","Campylobacter spp.",
                                                                          "Clostridium perfringens","STEC & DEC","Listeria monocytogenes",
                                                                          "Shigella spp.","Cryptosporidium spp.","Other[2]","Unknown[3]","Total"))

t5_1_5b_plot <- ggplot(t5_1_5b_long_labels1,aes(x=Year, y=val)) +
...
save_graphic(t5_1_5b_plot, "5.1.5b", "tot number human cases perc hosp facet")
