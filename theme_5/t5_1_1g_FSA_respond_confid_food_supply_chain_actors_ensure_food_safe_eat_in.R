...
t5_1_1g_long <- t5_1_1g_long |> 
  ...
  mutate(Wave_label = replace(Wave_label, Wave_label == "Wave 3 (04/2021- 06/2021)", "Wave 3")) |>
  mutate(Wave_label = replace(Wave_label, Wave_label == "Wave 4 (10/2021- 01/2022)", "Wave 4")) |>
  mutate(Wave_label = replace(Wave_label, Wave_label == "Wave 6 (10/2022- 01/2023)", "Wave 6")) |>
  mutate(Wave_label = replace(Wave_label, Wave_label == "Wave 7 (04/2023- 07/2023)", "Wave 7"))
